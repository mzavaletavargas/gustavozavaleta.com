<template>
  <div>
    ...
    >
      <div
        class="hidden flex-col items-center justify-center dark:bg-neutral-900 dark:text-white w-screen h-screen md:flex"
      >
        <div id="stars" class="self-start z-30"></div>
        <div id="stars2" class="self-start z-40"></div>
        <div id="stars3" class="self-start z-20"></div>
        <h1 class="font-mono dark:text-white z-50 text-4xl">
          {{ error.statusCode }} - Ooops... te encuentras perdido?
        </h1>
